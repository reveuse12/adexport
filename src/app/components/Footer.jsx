        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
          <div className="flex flex-col items-center">
            ...
            <div className="mb-12 grid w-full max-w-[208px] grid-flow-col grid-cols-4 gap-3">
              <Link
                href="#"
                className="ifont-bold hover:bg-black rounded-full mx-auto flex max-w-[24px] flex-col"
              >
                <Image
                  width={150}
                  height={150}
              ...
              <Link
                href="#"
                className="ifont-bold mx-auto hover:bg-black rounded-full flex max-w-[24px] flex-col"
              >
                <Image
                  width={150}
                  height={150}
